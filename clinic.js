...
var url = "mongodb://localhost:27017/patient's";
var app = express();
var fs = require("fs");
...
app.post("/get_treat",function(req,res){
    ...
    if(dis.some(function(val){return val=="headache"||val=="bodyache"||val=="sneezing"||val=="nose";})==true){
        ...
        res.render("treatment",{ name:name,
            age:age,
            gender:gender,
            med1:obj.cyclopam,
            num1:obj.num3,            
...
app.post("/get_coords",function(req,res){
    ...
    mongodb.collection("real_time").insertOne({
        Latitude:latitude,
        Longitude:longitude
    });
    res.render("success");
...
app.post("/set_details",function(req,res){
    ...
    mongodb.collection("details").insertOne({
        "Patient's name":pname,
        "Patient's number":pnumber
    });
    res.render("takeappointment");
});
